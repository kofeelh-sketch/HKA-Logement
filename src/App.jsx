  ...
  return (
    <div className="card" onClick={() => onOpen(l)} tabIndex={0} role="button"
      ...
      <div className="ph" style={{ background: GRADS[i % GRADS.length] }}>
        {l.photos && l.photos[0] && <img src={l.photos[0]} alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />}
      ...
      <div className="detail-inner">
        <div className="detail-photo">
          <div className="media-view" style={{ background: curBg }}>
            {cur.type === "photo" && cur.url && <img src={cur.url} alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />}
            {cur.type === "video" && !playing && posterUrl && <img src={posterUrl} alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />}
...
export default function HkaCourtage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (alive && rows && rows.length) setChambres(rows);
    })();
    return () => { alive = false; };
  }, [adminOk]);
